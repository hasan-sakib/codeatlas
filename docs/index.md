...
- [Module 11: Retriever](modules/retriever.md) — hybrid dense+sparse retrieval with Reciprocal Rank Fusion and Postgres hydration, with reranking and metrics cleanly deferred until Modules 12 and 20 exist to provide them.
